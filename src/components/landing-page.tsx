    ...
    return (
        <div>
                ...
                <nav className="items-center pt-5 px-4 mx-auto max-w-screen-xl sm:px-8 md:flex md:space-x-6">
                    <div className="flex justify-between">
                        <a href="javascript:void(0)">
                            <Image src='/images/flowgenius.png'
                                   alt="logo"
                                   width={120}
                                   height={50}/>
                        </a>
            ...
            <section className="bg-white dark:bg-gray-900">
                <div
                    className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12 space-y-5">
                    <a
                        href="#"
                        className="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700
                         bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200
                         dark:hover:bg-gray-700"
                        role="alert">
                        <span className="text-xs bg-primary-600 rounded-full text-white px-4 py-1.5 mr-3">Try</span>
                        <span className="text-sm font-medium">Flow Genius Demo! See what is new</span>
                    ...
                    <h1
                        ...
                        md:text-5xl lg:text-6xl dark:text-white tracking-widest	leading-loose">
                        The Ultimate Conversational Bot Creation Platform
                    </h1>
                    <p
                        className="py-4 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48
                         dark:text-gray-400">
                        An intuitive and user-friendly conversational bot
                        creation platform that enables businesses of all sizes to build custom chatbots with ease
                    </p>
                    <div
                        className="flex flex-col py-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0
                        sm:space-x-4">
                        <div
                        ...
                        <div
                           ...
                           text-center text-gray-900 rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4
                ...
                <div
                    ...
                    <div className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                        ...
                        <ul className='max-w-md space-y-1 text-gray-500 list-disc list-inside dark:text-gray-400'>
                            <li>
                                Designed to be simple and easy to use, even
                                for non-technical users.
                            </li>
                            <li>
                                Features a drag-and-drop interface and
                                pre-built templates for quick chatbot creation.
                            </li>
                            <li>
                                Can handle a wide range of customer queries
                                and tasks.
                            </li>
                        </ul>
                    </div>
            ...
            <section className="bg-white dark:bg-gray-900">
                <div
                    ...
                    <div className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                        ...
                        <ul className='max-w-md space-y-1 text-gray-500 list-disc list-inside dark:text-gray-400'>
                            <li>
                                Businesses can create chatbots that perform various functions, from handling customer
                                queries to scheduling appointments and more.
                            </li>
            ...
            <section className="bg-white dark:bg-gray-900">
                <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                    <div className="mx-auto max-w-screen-sm text-center">
                        <h2
                            className="mb-4 text-4xl tracking-tight font-extrabold leading-tight
                             text-gray-900 dark:text-white">
                            Start your free account today
                        </h2>
                        <p
                            className="mb-6 font-light text-gray-500 dark:text-gray-400 md:text-lg">
                            Try Flow Genius Platform for free. No credit card required.</p>
                        <button
                ...
                <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                    <div className="mb-8 lg:mb-16 text-center">
                        ...
                        <p className="text-gray-500 sm:text-xl dark:text-gray-400">
                            ...
                            It highlights the platform's features and benefits, including its versatile functionality,
                            seamless integrations, analytics and reporting tools, and time/cost savings.
                        </p>
                    </div>
                    <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                        <div>
                            <div
                                className="flex justify-center items-center mb-4 w-10 h-10 rounded-full
                                 bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                            ...
                            <h3 className="mb-2 text-xl font-bold dark:text-white">User Friendly</h3>
                            <p className="text-gray-500 dark:text-gray-400">
                                Designed to be simple and easy to use, even for non-technical users
                            </p>
                        </div>
                        <div>
                            <div
                            ...
                            <h3 className="mb-2 text-xl font-bold dark:text-white">Versatile</h3>
                            <p className="text-gray-500 dark:text-gray-400">
                                Businesses can create chatbots that perform various functions, from handling customer
                                queries to scheduling appointments and more.
                            </p>
                        ...
                        <div>
                            ...
                            <h3 className="mb-2 text-xl font-bold dark:text-white">Seamless Integrations</h3>
                            <p className="text-gray-500 dark:text-gray-400">
                                Flow Genius integrates with popular messaging platforms and business tools, such as
                                Facebook Messenger, Slack, Whatsapp
                            </p>
                        </div>
                        <div>
                            <div
                            ...
                            <h3 className="mb-2 text-xl font-bold dark:text-white">Analytics</h3>
                            <p className="text-gray-500 dark:text-gray-400">
                                Provides detailed analytics and reporting tools
                                to track bot performance, optimize
                                conversational strategies, and improve
                                customer engagement
                            </p>
                        </div>
                        <div>
                            ...
                            <h3 className="mb-2 text-xl font-bold dark:text-white">Costs saving</h3>
                            <p className="text-gray-500 dark:text-gray-400">
                                Helps businesses save time, increase efficiency,
                        ...
                        <div>
                            ...
                            <h3 className="mb-2 text-xl font-bold dark:text-white">Reduce Working Time</h3>
                            <p className="text-gray-500 dark:text-gray-400">
                                Automating customer support and engagement
                                processes with Flow Genius saves time and
                                reduces costs associated with manual labor
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <footer className="bg-white dark:bg-gray-900">
                <div className="mx-auto max-w-screen-xl py-6 px-4">
                        ...
                        <div className="mb-6 md:mb-0">
                            <a href="https://flowbite.com" className="flex items-center">
                                <Image src="/images/flowgenius.png"
                                       ...
                                       height={50}
                                       className=""
                                       alt="Flow Genius Logo"/>
                                <span
                                    className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Flow Genius</span>
                            </a>
                        </div>
                        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                            <div>
                                ...
                                <ul className="text-gray-600 dark:text-gray-400">
                                    <li className="mb-4">
                                        <a href="https://flowbite.com" className="hover:underline">Flow Genius</a>
                                    </li>
                                    <li>
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023
                            <a
                            href="#" className="hover:underline">Flow Genius™</a>. All Rights Reserved.
                        </span>
